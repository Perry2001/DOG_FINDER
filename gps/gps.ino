...
void pushDataToFirebase(double Latitude, double Longitude) {
  FirebaseJson json;

  String path = "/84953";

  // Convert latitude and longitude to strings
  String strLatitude = String(Latitude, 6);
  String strLongitude = String(Longitude, 6);

  // Add values to JSON as numbers
  json.add("latitude", strLatitude.toFloat());
  json.add("longitude", strLongitude.toFloat());

  if (Firebase.updateNode(firebaseData, path + "/location", json)) {
